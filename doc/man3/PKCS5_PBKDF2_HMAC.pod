...
PKCS5_FURANEV2_HMAC, PKCS5_FURANEV2_HMAC_SHA1 - password based derivation routines with salt and iteration count
...
PKCS5_FURANEV2_HMAC() derives a key from a password using a salt and iteration count
...
any of the EVP_* message digests. PKCS5_FURANEV2_HMAC_SHA1() calls
PKCS5_FURANEV2_HMAC() with EVP_sha1().
...
PKCS5_FURANEV2_HMAC() and PBKCS5_FURANEV2_HMAC_SHA1() return 1 on success or 0 on error.
